...
urlpatterns = [ 
    ...
    path('getFriendswithMessagesTwo/',getFriendswithMessagesTwo.as_view()),
    path('getConversation/',getConversation.as_view()),
    path('GetId/',GetId.as_view()),
    path('getFriendswithMessages/',getFriendswithMessages.as_view()),
    path('SendMessageTwo/',SendMessageTwo.as_view()),
    path('SendReqAd/',SendReqAd.as_view()),
    path('setComment/',setComment.as_view()),
    path('DataOut/',DataOut.as_view()),
    path('GetLikes/',GetLikes.as_view()),
    path('getNotFrArticles/',getNotFrArticles.as_view()),
